...
export const defaultYear = MONTH < 8 ? defaultYearList[1].value : defaultYearList[2].value;
export const defaultYearLabel = MONTH < 8 ? defaultYearList[1].label : defaultYearList[2].label;
